...
public:
	...
	// Límites máximos de efectos para prevenir memory leaks y degradación de rendimiento
#define MAX_EFFECTS_PER_MODE		500		// Máximo de efectos por modo de renderizado
#define MAX_TOTAL_EFFECTS			2000	// Máximo total de efectos activos
