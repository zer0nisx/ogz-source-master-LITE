...
bool ZGameInterface::InitInterfaceListener()
{
	...
	SetListenerWidget("EquipSortComboBox", ZGetEquipSortComboBoxListener());
...
void ZGameInterface::SaveScreenshot(bool Sync)
{
	...
	if (bFullscreen && Sync)
	{
		// Modo pantalla completa síncrono: usar GetFrontBufferData
	...
	{
		// Modo ventana o asíncrono: usar GetRenderTargetData
		V(pDevice->CreateOffscreenPlainSurface(nWidth, nHeight,
