...
if exist build\win32 (
	...
	call cd build/win32
	call cmake -G "Visual Studio 18 2026" -A Win32 -Wno-dev -DBUILD_SHARED_LIBS=OFF -DZLIB_LIBRARY="C:\ogz-source-master-LITE\src\sdk\zlib\lib\zlib.lib" -DZLIB_INCLUDE_DIR="C:\ogz-source-master\src\sdk\zlib\include" ..\..\src
